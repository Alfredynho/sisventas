...
def send_yelp_results(token, user_id, businesses):
    ...
    for business in businesses:
        ...
        img_url = business['image_url'] if business['image_url'] != "" else '/static/assets/img/empty-placeholder.jpg'
...
def send_trending_news(token, user_id, posts):
    options = []
    for post in posts:
        img_url = post['image_url'] if post['image_url'] != "" else url_for('static',
                                                                            filename='assets/img/empty-placeholder.jpg',
                                                                            _external=True)
        obj = {
            "title": post['title'],
            "image_url": img_url,
...
def set_menu():
    r = requests.post("https://graph.facebook.com/v2.6/me/thread_settings",
                      params={
                          "access_token": 'EAAFnesutK0QBAHZCGYgZAmMvfjQSEBP9K0DN5rvbxkVUgKSPKyK0FojOBETb99J6TL9HdNBr1pSfl7B64n1KxFKEHAzhgrf07acig5TGyaYY3rSpLHB2EbQxECHZCGoZA4AG6iXQPXj4tqhMZCqRwPAbxHB81zeIO5xe8ZB5lQxAZDZD'},
                      data=json.dumps({
